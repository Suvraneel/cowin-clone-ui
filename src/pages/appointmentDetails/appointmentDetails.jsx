...
class AppointmentDetails extends Component {
  ...
  getCenter = (appointment) => {
    const options = {
      url: "https://cowin-api-suvraneel.herokuapp.com/center/" + appointment.centerId,
      method: "GET",
      headers: {
  ...
  getAppointment = () => {
    const options = {
      url: "https://cowin-api-suvraneel.herokuapp.com/appointment/" + this.props.user.appointmentId,
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
